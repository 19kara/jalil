  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <button className="relative text-primary-foreground hover:text-accent transition-colors" aria-label="Panier">
          ...
          {items.length === 0 ? (
            ...
            <>
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t">
                ...
                <Button onClick={handleCheckout} className="w-full bg-accent text-accent-foreground hover:brightness-110" size="lg" disabled={items.length === 0 || isLoading || isSyncing}>
                  {isLoading || isSyncing ? (
